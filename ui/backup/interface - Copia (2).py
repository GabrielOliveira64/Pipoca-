...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.grid_layout.setHorizontalSpacing(2)  # Espaçamento horizontal mínimo
        self.grid_layout.setVerticalSpacing(2)    # Espaçamento vertical mínimo
    ...
    def toggle_menu(self):
        ...
        # Recarregar os filmes para ajustar o layout
        self.load_movies()
    ...
    def load_movies(self):
        ...
        spacing = 8      # Espaçamento uniforme de 8px
    ...
    def populate_genres(self, movies):
        ...
        # Se não houver gêneros, adicionar uma mensagem
        if not all_genres:
            no_genres_label = QLabel("Nenhum gênero disponível")
            no_genres_label.setStyleSheet("color: #888;")
            self.genres_layout.addWidget(no_genres_label)
            return
        
        # Adicionar cada gênero como um checkbox
        for genre in sorted(all_genres):
            checkbox = QCheckBox(genre)
            checkbox.setChecked(genre in self.selected_genres)
            checkbox.stateChanged.connect(lambda state, g=genre: self.toggle_genre_filter(g, state))
            self.genres_layout.addWidget(checkbox)
        
        self.genres_layout.addStretch()
    
    def toggle_genre_filter(self, genre, state):
        """Adiciona ou remove um gênero da lista de filtros."""
        if state == Qt.Checked:
        ...
        # Atualiza a lista de filmes com o novo filtro
        self.filter_movies()
    ...
    def resizeEvent(self, event):
        ...
        # Recarrega o layout para se adaptar ao novo tamanho
