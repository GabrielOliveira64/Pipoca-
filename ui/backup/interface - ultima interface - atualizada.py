...
class MainWindow(QMainWindow):
    ...
    def populate_genres(self, movies):
        ...
        # Adicionar cada gênero como um checkbox, prevenindo eventos de clique de propagar
        for genre in sorted(all_genres):
            # Criar um widget contenedor para isolar os eventos
            container = QWidget()
            ...
            # Configurar o checkbox para evitar propagação de eventos
            checkbox.setFocusPolicy(Qt.StrongFocus)
            
            container_layout.addWidget(checkbox)
            self.genres_layout.addWidget(container)
