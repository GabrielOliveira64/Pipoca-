...
class MovieInfoPage(QWidget):
    ...
    def init_ui(self):
        ...
        if directors:
            ...
            main_info_layout.addWidget(directors_container)
        ...
        if cast:
            ...
            cast_grid.setHorizontalSpacing(10)  # Reduzido o espaçamento horizontal
            ...
            main_info_layout.addWidget(cast_container)
