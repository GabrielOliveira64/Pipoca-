...
class MovieInfoPage(QWidget):
    ...
    def init_ui(self):
        ...
        if cast:
            ...
            cast_header_layout = QHBoxLayout()
            cast_header_layout.setSpacing(10)
            
            cast_title = QLabel("Elenco Principal")
            cast_title.setObjectName("sectionLabel")
            cast_header_layout.addWidget(cast_title)
            
            cast_header_layout.addStretch()  # Espaço entre o título e o botão
            
            # Botão SVG de navegação
            cast_nav_btn = QPushButton()
            cast_nav_btn.setObjectName("castNavButton")
            cast_nav_btn.setIcon(QIcon("assets/icons/chevron_right.png"))
            cast_nav_btn.setToolTip("Ver mais")
            cast_nav_btn.setFixedSize(40, 40)
            cast_nav_btn.clicked.connect(self.navigate_cast)
            cast_header_layout.addWidget(cast_nav_btn)
            
            cast_layout.addLayout(cast_header_layout)
            
            # Container para os atores (sem scroll, apenas um container fixo)
            cast_view = QWidget()
            ...
            # Limite de atores visíveis
            max_visible_actors = 6
            ...
            for actor_info in visible_cast:
                ...
                if actor_id and profile_path:
                    ...
                    if os.path.exists(actor_photo_path):
                        ...
                        actor_photo_label.setFixedSize(60, 60)
                else:
                    actor_photo_label.setText("Sem Foto")
                    actor_photo_label.setAlignment(Qt.AlignCenter)
                    actor_photo_label.setFixedSize(60, 60)
                ...
                actor_name_label.setFixedWidth(80)
        ...
        if date_added:
            try:
                ...
                main_info_layout_inner.addWidget(date_label)
            except:
                pass
    ...
    def apply_stylesheet(self):
        ...
        self.setStyleSheet("""
            ...
            QPushButton#castNavButton:hover {
                background-color: rgba(50, 50, 50, 0.8);
                border: 1px solid rgba(255, 255, 255, 0.2);
            }
        """)