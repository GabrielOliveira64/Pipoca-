...
class SplashScreen(QWidget):
    # Sinal para notificar que a animação terminou
    ...
    def update_shine(self):
        ...
        # Finalizar animação de brilho após 6 alterações
        if self.counter >= 6:
    ...
    def start_final_animation(self):
        ...
        self.final_animation.finished.connect(self.emit_finished)
        self.final_animation.start()
    
    def emit_finished(self):
        # Emitir o sinal de animação concluída
